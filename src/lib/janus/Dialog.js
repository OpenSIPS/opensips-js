...
import Dialog_RequestSender from 'jssip/lib/Dialog/RequestSender'
...
class Dialog {
    ...
    constructor (owner, message, type, state = C.STATUS_CONFIRMED) {
        ...
        if (type === 'UAS') {
            ...
            let remoteTarget = message.getHeaders('to')[0].split(';')[0]
            remoteTarget = remoteTarget.match(/<([^>]*)>/)[1]
            this._remote_target = remoteTarget//contact.uri
