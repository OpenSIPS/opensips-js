...
export default class RTCSession extends EventEmitter {
    ...
    connect (target, options = {}, initCallback) {
        ...
        console.log('rtcOfferConstraints', rtcOfferConstraints)
    ...
    _sendInitialRequest (mediaConstraints, rtcOfferConstraints, mediaStream) {
        ...
        setTimeout(() => {
            console.log('_sendInitialRequest request_sender', request_sender._request.body)
        }, 1500)
    ...
    _sendReinvite (options = {}) {
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
            ...
            .then((sdp) => {
                ...
                console.log('this.sendRequest(JsSIP_C.INVITE', sdp)
