  ...
  <div>
    ...
    <ul>
      <li>
        ...
        <span>
          Check Vue.js 3 wrapper for opensips <a href="https://github.com/VoicenterTeam/vsip-next">here</a>.
        </span>
        <p>
          Use <code>npm i @voicenter-team/vsip-next</code> to install module.
        </p>
      </li>
      ...
      <li>
        ...
        <span>
          Check React Native wrapper for opensips
          <a href="https://github.com/VoicenterTeam/opensips-react-native">here</a>.
        </span>
        <p>
          Use <code>npm i @voicenter-team/react-native-opensips</code> to install module.
        </p>
      </li>
    ...
    <ul>
      ...
      <li>
        <b>Electron Desktop Application</b>:
        <span>
      ...
      <li>
        <b>Contact Us Websites Widgets SDK</b>:
        <span>
      ...
      <li>
        <b>Legacy Website Integration & Other</b>:
        <span>
