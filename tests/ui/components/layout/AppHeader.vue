<template>
    <header
        class="bg-background/75 backdrop-blur border-b -mb-px border-gray-200 dark:border-gray-600 sticky top-0 z-10"
    >
        <div
            class="mx-auto px-4 sm:px-6 lg:px-8 max-w-[1900px] flex items-center justify-between gap-3 h-[--header-height]"
        >
            <div>
                <svg
                    width="1020"
...
import ButtonColorMode from '~/components/main/ButtonColorMode.vue'
</script>
